...
function showModifyOption(id, row, oldButtons){
    ...
    row.cells[2].innerHTML = '<input type="text" name="code" value="' + code + '">';
    ...
    fetch('ServletModifyTournoi', {
        ...
        .then(data => {
            if (data.updated){
                ...
                console.log("Erreur lors de la modification du tournoi");
            }
        })
